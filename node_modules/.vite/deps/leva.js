...
function Row(_ref) {
  ...
  if (input) return import_react20.default.createElement(StyledInputRow, props3);
...
function String$1(_ref) {
  ...
  if (editable) return import_react20.default.createElement(ValueInput, _extends2({
    value: displayValue,
    onUpdate,
    onChange
  }, props3));
